...
\begin{enumerate}
  ...
  Responder essas questões é tarefa essencial para compreensão dos limites de uma representação. Por seu turno, ter em contas essa restrições é fundamental para se possa validá-la ou não.
