...
\citeonline{Weintrop2016} sustenta que a capacidade de analisar e extrair significado de um grande volume tem sido uma das características definidoras da prática científica moderna. A maneira como esse empreendimento vem sendo conduzido tem sido impactados significativamente pelos avanços tecnológicos. 

Para ilustrar a relevância que análise de dados tem na pesquisa científica, o autor destaca uma das entrevistas feitas durante elaboração da taxonomia na qual um cientista de materiais, questionado sobre como era sua pesquisa, responde: ``Em quase tudo, o que se tem são dados brutos''. Em seguida ele prossegue explicando como ele define as perguntas a serem respondidas (problemas de pesquisa), e como dados são gerados, processados e organizados, para que então, finalmente, ela possa usar softwares que gerem as visualizações para suas conclusões. 
