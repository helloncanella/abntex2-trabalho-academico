...
\input{elementos-textuais/tabela-competencias-barr.tex}
...
\begin{enumerate}
  ...
  \input{elementos-textuais/tabela-dez-competencias-pensamento-computacional.tex}
  ...
  \input{elementos-textuais/facetas-pensamento-computacional.tex}
...
\subsection{Práticas de simulação e modelagem}
...
Nesta etapa de elaboração da taxonomia \citeonline{Weintrop2016} concentra seus esforços para discutir as práticas de resolução de problemas trazidas pela ciência da computação. Seguem destrinchadas cada uma delas. 
...
\begin{enumerate}
  ...
  Dentre as várias estratégias existentes que possibilitam esse reenquadramento,  \citeonline{Weintrop2016} lista a possibilidade de decomposição de um problema em outros menores, ou simplesmente a sua reedição em termos de outros, cujas soluções são conhecidas. 
  ...
  % Nas ciências, uma vasta gama de ferramentas computacionais pode ser empregada para uma determinada atividade; O desafio é mapear problemas nas capacidades das ferramentas.

  % Estratégias para fazer isso incluem decompor problemas em subproblemas, reenquadrar novos problemas em problemas conhecidos para os quais já existem ferramentas computacionais e simplificar problemas complexos para que o mapeamento de recursos de problemas em soluções computacionais seja mais acessível.

  % Os estudantes que dominam esta prática poderão empregar tais estratégias para reenquadrar problemas em formulários que possam ser resolvidos, ou pelo menos progresso, através do uso de ferramentas computacionais.

  \item \textbf{Programação} 

  O emprego da codificação na resolução de problemas tem se mostrado um poderosa ferramenta na resolução de problemas. Dentre as vários possibilidades que essa habilidade tem trazido para pesquisa científica, pode-se destacar a coleta e análise massiva de dados, a formatação e visualização de informações, bem como a construção e extensão de modelos e interfaces com ferramentas computacionais existentes \cite{Weintrop2016}. 
  
  O ensino de programação, contudo, tem se mostrado um tarefa desafiadora, em face tanto da pouca ou nenhuma disponibilidade de programa de capacitação para professores quanto à dificuldade de aprendizado relacionada a sintaxe das linguagens de programação convencionais. 
  
  Para contornar estas dificuldades, tem sido desenvolvidos linguagem e plataformas de programação visual, cujo arranjo algorítmico e sintático das instruções dadas são estruturados por elementos gráficos e não textuais. Dos exemplos com esta finalidade, o mais proeminente é o \textit{Scratch}, sobre o qual já falamos na seção \ref{significado-pensamento-computacional}. 

  \begin{figure}[!htb]
    \caption{Scratch - linguagem e plataforma de programação}
    \begin{center}
  ...
  % principalmente quando o foco da instrução estão a linguagens de programação convencionais.

  
  
  
  % A começar pela diminuta quantidade de professores capacitados.
  ...
  % Programas que variam de scripts Python de dez linhas a bibliotecas C ++ de várias milhões de linhas podem ser valiosos para coleta e análise de dados, visualização de informações, construção e extensão de modelos computacionais e interface com outras ferramentas computacionais existentes.

  % Esta prática consiste em entender e modificar programas escritos por outros, assim como compor novos programas ou scripts a partir do zero.

  % Essa categoria inclui a compreensão de conceitos de programação, como lógica condicional, lógica iterativa e recursão, bem como a criação de abstrações, como sub-rotinas e estruturas de dados.

  % Embora não seja razoável esperar que todos os alunos sejam especialistas em programação, a proficiência básica em programação é um componente importante da investigação científica do século XXI.

  % Os alunos que dominam essa prática serão capazes de entender, modificar e criar programas de computador e usar essas habilidades para avançar em suas próprias atividades científicas e matemáticas.

  % A capacidade de codificar instruções de forma que um computador possa executá-las é uma habilidade poderosa para investigar e resolver problemas matemáticos e científicos.
