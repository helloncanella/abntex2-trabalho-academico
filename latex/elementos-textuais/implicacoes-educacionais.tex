...
\begin{enumerate}
  ...
  Como assinala o autor, o estudante que dominar esta prática será capaz de definir procedimentos computacionais e executar simulações que permitam a criação de dados que possam ser utilizados para aprofundar sua compreensão em um tópico sob investigação.
