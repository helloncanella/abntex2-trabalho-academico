...
\begin{enumerate}
  ...
  % Ao trabalhar para um resultado científico ou matemático específico, muitas vezes há várias etapas ou componentes envolvidos no processo; Essas etapas, por sua vez, podem ser divididas de várias formas, afetando sua capacidade de serem facilmente reutilizadas, reaproveitadas e depuradas.


  % A resolução de um problema complexo pode ser projetada de modo intrincado, tendo como referencia apenas seus requisitos,
  
  
  
  
  % sequencia-se em um conjunto etapas menores e assume forma na solução de outros menores. 
  
  % Cada uma dessas soluções podem ser desenhadas de modo intrincado, visando apenas o problema em questão, ou podem ser 




  Ordinariamente, a resolução de um problema complexo sequencia-se em um conjunto etapas menores e assume forma na solução de outros menores. 
  ...
  % Os elementos de uma solução podem ser grandes, complicados e projetados exclusivamente para o problema em questão, ou podem ser pequenos, modulares e reutilizáveis.
% 
  % O desenvolvimento de soluções computacionais de uma maneira modular e reutilizável tem muitas implicações para o problema imediato e problemas futuros que podem ser encontrados.



  % Ao desenvolver soluções modulares, é mais fácil construir soluções de forma incremental, testar componentes de forma independente e aumentar a probabilidade de que os componentes sejam úteis para problemas futuros.

  % Os alunos que dominam essa prática poderão desenvolver soluções que consistem em componentes modulares e reutilizáveis ​​e aproveitar a modularidade de sua solução, tanto trabalhando no problema atual quanto reutilizando partes de soluções anteriores ao enfrentar novos desafios.
