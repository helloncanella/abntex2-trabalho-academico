...
A figura \ref{fig:planetario} vemos uma boa distinção desses conceitos. Em \ref{fig:interface}, temos um planetário mecânico que pode ser tomado como um modelo para sistema solar, o que materializa a ideia de ``abstração como modelo''. Em \ref{fig:componente}, temos um 
