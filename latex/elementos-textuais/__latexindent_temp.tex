...
No contexto da computação científica, o uso de abstrações se dá a partir da construção e uso de modelos matemáticos. Estabelece-se aí a noção de abstração como modelagem. %mas 
