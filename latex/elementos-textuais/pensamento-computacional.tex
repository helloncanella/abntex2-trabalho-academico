...
Comecemos com o conceito de modelo matemático.
...
Vemos na figura \ref{fig:modelo_matematico} uma esquema simplificado do elementos no desenho de um modelo matemático.
