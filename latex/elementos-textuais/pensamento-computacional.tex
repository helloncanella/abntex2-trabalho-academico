...
A necessidade de ser criar um modelo nasce normalmente da intenção de se criar uma representação de um sistema ou processo, como no caso das ciências físicas onde se buscam representações para fenômenos da realidade. 
