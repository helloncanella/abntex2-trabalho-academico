...
Da reflexão sobre o papel da ciência da computação no desenvolvimento da prática científica nasce a noção de um ``pensamento computacional''. Tema que desdobraremos a seguir.

\vspace{1cm}

\section{A ciência da computação na investigação científica: o pensamento computacional}
